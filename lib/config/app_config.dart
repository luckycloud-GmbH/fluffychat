...
abstract class AppConfig {
  ...
  static String _logoType = 'svg';
  static String get logoType => _logoType;
  ...
  static String homeserverHintText = 'https://storage.luckycloud.de';
  ...
  static void loadFromJson(Map<String, dynamic> json) {
    ...
    if (json['login_logo_type'] is String) {
      _logoType = json['login_logo_type'];
    }
