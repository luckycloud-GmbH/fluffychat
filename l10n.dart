...
abstract class L10n {
  ...
  /// No description provided for @homeserverHintText.
  ///
  /// In en, this message translates to:
  /// **'Enter your chat URL'**
  /// In de, this message translates to:
  /// **'Deine Chat URL eingeben'**
  String get homeserverHintText;
}
...
class _L10nDelegate extends LocalizationsDelegate<L10n> {
  ...
  @override
  bool isSupported(Locale locale) => <String>['ar', 'be', 'bn', 'bo', 'ca', 'cs', 'de', 'el', 'en', 'eo', 'es', 'et', 'eu', 'fa', 'fi', 'fil', 'fr', 'ga', 'gl', 'he', 'hi', 'hr', 'hu', 'ia', 'id', 'ie', 'it', 'ja', 'ka', 'ko', 'lt', 'lv', 'nb', 'nl', 'pl', 'pt', 'ro', 'ru', 'sk', 'sl', 'sr', 'sv', 'ta', 'th', 'tr', 'uk', 'vi', 'zh'].contains(locale.languageCode);
